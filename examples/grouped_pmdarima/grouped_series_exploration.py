import pprint
from diviner import PmdarimaUtils
...
if __name__ == "__main__":
    ...
    generated_data = generate_example_data(column_count=4, series_count=20, series_size=365*12, start_dt="2010-01-01", days_period=1)
    ...
    util = PmdarimaUtils(df=training_data, group_key_columns=group_key_columns, y_col="y", datetime_col="ds")

    # Decompose the trends of each group
    decomposed_trends = util.decompose_groups(m=7, type_="additive")
